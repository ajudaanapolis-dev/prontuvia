...
export function App(): JSX.Element | null {
  ...
  return (
    <AppShell
      logo={<img src="/prontuvia-symbol.png" width={30} height={30} alt="Prontuvia" />}
      ...
      menus={
        profile
          ? [
              {
                links: [
                  { icon: <IconBook2 />, label: 'Equipe clínica', href: '/Spaces/Communication' },
                  {
                    icon: <IconUsers />,
                    label: 'Pacientes',
                  ...
                  { icon: <IconPrinter />, label: 'Documentos recebidos', href: '/Fax/Communication' },
                ],
              },
              {
                title: 'Acesso rápido',
                links: [
                  ...(!setupDismissed
                    ...
                    : []),
                  { icon: <IconUserPlus />, label: 'Novo paciente', href: '/onboarding' },
                  { icon: <IconApps />, label: 'Integrações', href: '/integrations' },
                  ...(hasDoseSpot
                    ? [
                        {
                          icon: <IconPill />,
